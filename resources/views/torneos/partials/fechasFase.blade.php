...
<table class="table">
	...
	<tbody>
		<tr ng-repeat="fecha in vm.fechas">
			...
			<td>
				<div class="btn-group">
			        <label class="btn btn-success" ng-change="vm.actualizarFecha(fecha)" ng-model="fecha.fec_estado" btn-radio="'jugada'">Jugada</label>
			        <label class="btn btn-primary" ng-change="vm.actualizarFecha(fecha)" ng-model="fecha.fec_estado" btn-radio="'no_jugada'">No jugada</label>
			        <label class="btn btn-warning" ng-change="vm.actualizarFecha(fecha)" ng-model="fecha.fec_estado" btn-radio="'en_juego'">En juego</label>
			        <label class="btn btn-danger" ng-change="vm.actualizarFecha(fecha)" ng-model="fecha.fec_estado" btn-radio="'suspendida'">Suspendida</label>
			    </div>
			</td>
